...
| `minimal-public.json` | **ลูกค้าสาย v1.6.0 เท่านั้น** (public `3fff3b4c`) — copy GCS→GCS จาก `minimal.json` ที่ลูกค้าโหลดอยู่ (= commit `7b8d671` 2026-09-07 · 779,225 B · **ไม่เท่า `minimal.json` ในรีโป** ที่มี v7–v15 ยังไม่ push) · tool public ยังชี้ชื่อเก่าจนขั้น ⑤ | 🔴 ห้าม push จนพี่หมีสั่ง |
...
| `minimal-v2.json` | **ลูกค้าสาย v2** — public `EasyBear Minimal v2.0.0` (`bb6139f5` · is_current บน airefills ตั้งแต่ 2026-09-14) โหลดไฟล์นี้ตรง ๆ (ทีม minimal ตรวจ get_code 2026-09-17) · **ไม่ใช่ alias ของ minimal-dev** (md5 tH6+aJ… 1,344,506 B ≠ minimal-dev) | 🔴 live ลูกค้า · ห้าม push/ลบ จนพี่หมีสั่ง |
