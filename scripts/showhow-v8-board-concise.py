...
def prompt_for(k):
    ...
    parts.append(f'\nบังคับเลย์เอาต์: ตาราง 5 แถว × 4 คอลัมน์ เต็มภาพชิดขอบ เส้นแบ่งชัด (ไม่ใช่ภาพถ่ายกระดาษ/สมุด ไม่มีกรอบแท็บเล็ตหรือมือถือรอบนอก) · มีแถวหัวคอลัมน์ · 1 แถว = 1 ฉาก เรียงบนลงล่าง ครบ {first}-{last} · ภาพถ่ายอยู่คอลัมน์ "ภาพ" ช่องละ 1 ภาพเท่านั้น คอลัมน์อื่นเป็นตัวหนังสือล้วน'
    ...
    parts.append('" · คอลัมน์ฉาก = ป้ายต้นบรรทัดของแถวนั้นคัดเป๊ะ · คอลัมน์มุมกล้อง = มุมกล้องของแถว · คอลัมน์เสียง = ')
