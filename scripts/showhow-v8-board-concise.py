...
def prompt_for(k):
    ...
    # v8.8: บอร์ดช่วง 2+ เอาชื่อเรื่องจากบรรทัดแรกไปพิมพ์เป็นหัวเรื่องเหนือตาราง (ช่วง 6 หลุดเป็นอังกฤษ "How-To · Part 6") ⇒ บอกว่าบรรทัดแรกเป็นข้อมูลกำกับ
    parts.append('" · ชื่อเรื่องกับเลขช่วงในบรรทัดแรกเป็นข้อมูลกำกับ ห้ามพิมพ์ลงบนภาพ · คอลัมน์ฉาก = ป้ายต้นบรรทัดของแถวนั้นคัดเป๊ะ · คอลัมน์มุมกล้อง = มุมกล้องของแถว (ภาษาไทยตามบท) · คอลัมน์เสียง = ')
